-- =========================================================
-- FGZ UNIVERSAL SCRIPT V1.8 - ULTIMATE EXPANDED EDITION
-- =========================================================
...
-- Konfigurasi Ikon Baru (Mendukung ID dan Emoji)
getgenv().FgzConfig = {
    Title = "Fgz Universal Script",
    Subtitle = "Made With ❤️ By Fawwazx",
    Icon = "🕹️",
    MainIcon = "rbxassetid://7733960981",     -- Ikon Home
    MovementIcon = "👣",                      -- Emoji Baru
    VisualsIcon = "👀",                       -- Emoji Baru
    PlayerIcon = "rbxassetid://7734068321",   -- Ikon Profil
    PremiumIcon = "💲"                        -- Emoji Baru
}
...
MainFrame.Size = UDim2.new(0, 480, 0, 300) -- Diperbesar sedikit agar lega
...
-- Perbaikan Ruang Tab dan Profile (Pas-in Layout)
local TabContainer = Instance.new("ScrollingFrame", Sidebar)
TabContainer.Size = UDim2.new(1, 0, 1, -95) -- Disempurnakan untuk Profile Frame
...
-- Player Profile yang Sudah Di-paskan
local ProfileFrame = Instance.new("Frame", Sidebar)
ProfileFrame.Size = UDim2.new(1, -10, 0, 85)
ProfileFrame.Position = UDim2.new(0, 5, 1, -90)
...
Avatar.Position = UDim2.new(0, 6, 0, 10)
...
PId.Position = UDim2.new(0, 40, 0, 24)
...
-- Watermark Teks Baru (Di tengah bawah)
...
Watermark.TextSize = 8 -- Dikecilkan sedikit agar fit dengan emoji
...
local function createTab(name, iconID, order)
    ...
    local Icon
    -- Logika cerdas untuk membedakan rbxassetid dan Emoji Teks
...
-- === MOVEMENT TAB (Perbanyakan Fitur) ===
    ...
    for _, p in pairs(Players:GetPlayers()) do
        if p ~= LocalPlayer then
            ...
            pBtn.MouseButton1Click:Connect(function()
                TargetPlayerName = p.Name; TpBtn.Text = "Teleport To: " .. p.Name
            end)
        end
    end
end
